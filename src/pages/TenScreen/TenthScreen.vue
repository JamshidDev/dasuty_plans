...
const arr1 = [
    {offset: -12, name: 'HRM', deadline: '30.06.2024', url: 'https://exodim.railway.uz', value: 89, rate: 40},
    {offset: 0, name: 'RAIL OBSERVER', deadline: '01.05.2024', url: 'https://railwayobserver.uz', value: 80, rate: 50},
    ...
    {offset: 5, name: 'RELAY CONTROL', deadline: '31.05.2024', url: 'http://relay.itdevs.uz/', value: 72, rate: 0},
    {offset: -2, name: 'VIRTUAL OFFICE', deadline: '01.01.2025', url: '/', value: 25, rate: 30},
    {offset: -16, name: 'ERP', value: 15, deadline: '31.03.2025', url: '/', rate: 15},
]

const arr2 = [
    {offset: -12, name: 'E-NAKL', deadline: '31.05.2024', url: 'https://e-nakl.railway.uz', value: 92, rate: 17},
    {offset: 0, name: 'TRAIN LOCATION', deadline: '15.06.2024', url: 'hhttps://tracking.railway.uz', value: 91, rate: 32},
