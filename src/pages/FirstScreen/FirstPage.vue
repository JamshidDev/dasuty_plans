...
<!--      title-->
      ...
      <ChartText :content_text="'TEZKOR TELEGRAF'" site_link="`https://telegraf.railwayinfra.uz/`" :content_info="`Алоқа хўжалиги (телеграф маълумотларини тезкор юбориш) (01.11.2024)`"  :chart_persant="65" :positionTop="4" :slide="'left'"></ChartText>
