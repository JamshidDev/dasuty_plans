  ...
  <svg fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="SVGRepo_iconCarrier">
      <path
          ...
          fill="#11A832"></path>
      <path d="M5 6H15.5752" stroke="#11A832" stroke-linecap="round" stroke-width="1.5"></path>
      <path d="M5 11H10.2374" stroke="#11A832" stroke-linecap="round" stroke-width="1.5"></path>
      <path d="M5 16H7.24461" stroke="#11A832" stroke-linecap="round" stroke-width="1.5"></path>
      <circle cx="17.5" cy="17.5" r="5.5" stroke="#11A832" stroke-width="1.5"></circle>
      <path d="M15.5 18L16.5826 19.0826C16.8011 19.3011 17.1635 19.2711 17.3431 19.0197L19.5 16" stroke="#11A832"
