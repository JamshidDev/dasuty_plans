...
export const teamList = [
  {
    ...
    tasks: [
      { title: 'Yo’l xo’jaligi korxonalari profillarini o’zgartirish', deadline: '2024-03-04' }
    ]
  },
  {
  ...
  },
  {
    ...
    tasks: [
      { title: 'GU45 pamyatkani yopishdagi nazoratlarni to’liq o’rnatish', deadline: '2024-03-05' }
    ]
  },
  {
  ...
  },
  {
    name: 'Toʻlqinov Akmal', position: 'Frontend Developer', projects: [projectList.enakl.id], tasks: [
      { title: 'ENAKL Dashboardini qayta shakllantirish', deadline: '2024-03-10' }
    ]
  },
  {
    name: 'Xamdamov Jaxongir', position: 'Backend Developer', projects: [projectList.enakl.id], tasks: [
      { title: 'Tex Kontora va ASU profillarida DU1 soobsheniya qismini optimizatsiya qilish', deadline: '2024-03-05' }
    ]
  },
  {
    name: 'Mahmudov Ramzxon', position: 'Project Manager', projects: [projectList.enaklM.id], tasks: [
      { title: 'Enakl mobile Zayavka qismini yakunlash', deadline: '2024-03-05' }
    ]
  },
  {
    name: 'Xasanov Zaxriddin', position: 'Backend Developer', projects: [projectList.enakl.id], tasks: [
      { title: 'Tamojniy bilan integratsiya', deadline: '2024-03-04' }
    ]
  },
  {
  ...
  },
  {
    name: 'Yakubov Quronboy', position: 'Backend Developer', projects: [projectList.enakl.id], tasks: [
      { title: 'M slujba otchetlari', deadline: '2024-03-07' }
    ]
  },
]
