...
export const teamList = [
    ...
    },
    {
        ...
        tasks: [
            {title: 'SMGS ga ustunlarni qo’shish', deadline: '2024-11-04'}
        ]
    },
    {
        ...
        projects: [projectList.enakl.id, projectList.erp.id, projectList.trainLocation.id],
        tasks: [
            {title: 'Temir yo’l kartasini optimizatsiya qilish', deadline: '2024-9-11'}
        ]
    },
    {
        name: 'Boboqulov Jobir', position: 'Backend Developer (Team Lead)', projects: [projectList.erp.id, projectList.trainLocation.id], tasks: [
            {title: 'Buyruqlarni tizimdan tasdiqlash', deadline: '2024-8-05'}
        ]
    },
    {
        ...
        tasks: [
            {title: 'Elektron bashmak qurilmasini yaratish', deadline: '2024-10-29'}
        ]
    },
    {
        name: 'Yodgorov Zafar',
        ...
        tasks: [
            {title: 'Virtual ofis yo’riqnoma modulini yaratish', deadline: '2024-11-10'}
        ]
    },
    {
    ...
    },
    {
        ...
        tasks: [
            {title: 'Enakl mobile Zayavka qismini yakunlash', deadline: '2024-9-06'}
        ]
    },
    {
        name: 'Narziyev Orzu', position: 'Backend Developer', projects: [projectList.vOffice.id, projectList.erp.id],
        tasks: [
            {title: 'Virtual ofis yo’riqnoma modulini yaratish', deadline: '2024-9-10'}
        ]
    },
    {
        name: 'Qorayev Farrux',
    ...
    },
    {
        ...
        tasks: [
            {title: 'GU45 pamyatkani yopishdagi nazoratlarni to’liq o’rnatish', deadline: '2024-8-05'}
        ]
    },
    {
        name: 'Raximov Jamshid', position: 'Frontend Developer', projects: [projectList.erp.id, projectList.trainLocation.id], tasks: [
            {title: 'Buyruqlarni tizimdan tasdiqlash', deadline: '2024-9-05'}
        ]
    },
    {
        name: 'Toʻlqinov Akmal', position: 'Frontend Developer', projects: [projectList.enakl.id], tasks: [
            {title: 'ENAKL Dashboardini qayta shakllantirish', deadline: '2024-9-10'}
        ]
    },
    {
    ...
    },
    {
        name: 'Mahmudov Ramzxon', position: 'Project Manager', projects: [projectList.enaklM.id], tasks: [
            {title: 'Enakl mobile Zayavka qismini yakunlash', deadline: '2024-9-05'}
        ]
    },
    {
        name: 'Xasanov Zaxriddin', position: 'Backend Developer', projects: [projectList.enakl.id], tasks: [
            {title: 'Tamojniy bilan integratsiya', deadline: '2024-8-04'}
        ]
    },
    {
        ...
        tasks: [
            {title: 'Enakl mobile Zayavka qismi dizaynini yakunlash', deadline: '2024-9-04'}
        ]
    },
    {
